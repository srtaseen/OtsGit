...
public partial class Export_Report : System.Web.UI.Page
{
    ...
    protected void btnsrc_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlDataAdapter adapter = new SqlDataAdapter("Sp_ExportReport '" + this.txtDate.Text + "','" + this.drpFactory.SelectedValue + "'", cn);
            ...
            else
            {
                ...
                GridView1.Columns[3].FooterText = "Total Export Qty";
