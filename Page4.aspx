<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Page4.aspx.cs" Inherits="Page4_" %>
        ...
        <ContentTemplate>
            ...
            <div style="width: 100%; height: 300px; float: left; margin-top: 4px; overflow: auto;">
                ...
                <asp:GridView ID="gvedit" runat="server" AutoGenerateColumns="False" CellPadding="2" PagerSettings-PageButtonCount="5" PagerSettings-Position="Bottom" OnPageIndexChanging="gvedit_PageIndexChanging"
                    GridLines="None" PageSize="10" AllowPaging="True" CssClass="gridcss2" DataKeyNames="po_id"
                   ...
                   <HeaderStyle CssClass="gridheade" />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PO Number">
                            <ItemTemplate>
                                <asp:Label ID="lblpo" runat="server" Text='<%# Eval("po_no")%>' CssClass="Gridtextbox1"
                                    Width="80px"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtpono" runat="server" Text='<%# Eval("po_no")%>' CssClass="Gridtextbox"
                        ...
                        <asp:TemplateField HeaderText="Quantity">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("po_quantity")%>' CssClass="Gridtextbox1"
                                    Width="80px"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtquantity" runat="server" Text='<%# Eval("po_quantity")%>' CssClass="Gridtextbox"
                                    Width="80px"></asp:TextBox>
                            </EditItemTemplate>
                            <HeaderStyle CssClass="ord_hdr" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Price">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("po_price")%>' CssClass="Gridtextbox1"
                                    Font-Size="11px" Width="80px"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="textprice" runat="server" Text='<%# Eval("po_price")%>' CssClass="Gridtextbox"
                        ...
                        <asp:TemplateField HeaderText="Total Price">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Totalprice")%>' CssClass="Gridtextbox1"
                                    Font-Size="11px" Width="80px"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="texttprice" runat="server" Text='<%# Eval("Totalprice")%>' CssClass="Gridtextbox"
                                    Width="80px" Font-Size="11px"></asp:TextBox>
                            </EditItemTemplate>
                            <HeaderStyle CssClass="ord_hdr" />
                        </asp:TemplateField>
