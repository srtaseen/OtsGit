<%@ Page Title="OTS | AOP EVENTS" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true"
    CodeFile="Page23.aspx.cs" Inherits="Page12" %>
                ...
                <div class="divnv">
                    <div style="float: left">
                        ...
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="MhyperLnkD" 
                            BackColor="#ECF1FF"  Font-Underline="False"><i class="fa fa-caret-left"></i> AOP EVENTS</asp:HyperLink>
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
        <div class="divbody2">
                    ...
                    <div style="background-color: #3a5795; width: 100%; height: 40px; float: left">
                        <table style="border-collapse: separate; border-spacing: 2px; float: left; margin-left: 4px;
                            ...
                            <tr>
                                ...
                                <td>
                                 <asp:DropDownList ID="ddlbuyerAOP" CssClass="textbox" runat="server" Width="152px" 
                                            Font-Size="11px" >
            ...
            <div style="float: left; overflow: auto; width: 99.9%;">
                ...
                <asp:UpdatePanel ID="up3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GvAOP" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            CssClass="gridcss4" OnRowDataBound="GvAOP_OnRowDataBound" AllowPaging="True" PagerSettings-PageButtonCount="5"
                            PagerSettings-Position="Bottom" PageSize="19" OnPageIndexChanging="GvAOP_PageIndexChanging">
                            ...
                            <Columns>
                                <asp:TemplateField>
                                        <HeaderTemplate>
                                            ...
                                            <th colspan="14" >
                                              <span style="padding-left: 10px; float: left">ALL OVER PRINT EVENTS</span>
                                            </th>
                                            <tr>
                                                <th>
                                                </th>
                                        ...
                                        <ItemTemplate>
                                         ...
                                         <td >
                                            ...
                                            <td >
                                               ...
                                               <asp:Button ID="btnActualpln" Enabled="false" Text='<%# Eval("Tnaac58","{0:dd/MMM/yyyy}")%>'
                                            ...
                                            <td >
                                               ...
                                               <asp:Button ID="btnActualpln2" Enabled="false" Text='<%# Eval("Tnaac59","{0:dd/MMM/yyyy}")%>'
                    ...
                    <div style="padding: 4px; margin-top: 2px; float: left; background-color: #3a5795;" id="dv1" runat="server">
                        <table >
                            ...
                            <tr>
                                ...
                                <td width="50px">
                                    <asp:Label ID="lblraop" runat="server" CssClass="lbl1" BackColor="#FFFF66" Text="" Font-Bold="true"
                                ...
                                <td style=" width="50px">
                                    <asp:Label ID="lblraop2" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="#FF8A6C" Font-Size="13px"></asp:Label>
                                </td>
                                <td align="right" width="40px">
                                    <span style="padding: 2px 2px 2px 0px; font-weight: bolder; font-size: 13px; font-family: Arial, Helvetica, sans-serif;">
                                        %</span>
