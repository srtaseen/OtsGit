<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Dashboard4.aspx.cs" Inherits="Dashboard4" %>
                ...
                <asp:TabPanel ID="TabPanel1" runat="server">
                    <ContentTemplate>
                        <div style="background-color: #3a5795; width: 100%; height: 40px; float: left">
                         ...
                         <h2 style="text-align:center;">Buyerwise Monthly Order Quantity for Year 2015</h2>
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td align="right" width="40px" style="padding-left:40px; padding-top:10px;">
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lbl15" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="#4ca9ff" ForeColor="White"
                                            Font-Size="15px"></asp:Label>
                                    </td>
