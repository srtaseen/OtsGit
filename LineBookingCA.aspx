<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LineBookingCA.aspx.cs" Inherits="LineBookingCA" %>
            ...
            <%--Date changer calculation--%>
             ...
             <asp:HyperLink ID="HyperLink4" runat="server" CssClass="MhyperLnk" width="15%"
                 ...
                 <asp:HyperLink ID="HyperLink7" runat="server" CssClass="MhyperLnk" width="15%"
                    BackColor="#ECF1FF" NavigateUrl="~/LineBookingToolCA.aspx"><i class="fa fa-bars"></i> PLANNING DASHBOARD</asp:HyperLink> 
                  
                  <asp:HyperLink ID="HyperLink8" runat="server" CssClass="MhyperLnk" width="12%"
                    BackColor="#ECF1FF" NavigateUrl="~/LinePlanHome.aspx"><i class="fa fa-bars"></i> LINE PLAN REPORT</asp:HyperLink>          
...
<script type="text/javascript">
                                ...
                                BorderStyle="None" Width="50px" ValidationGroup="btnsave" OnClick="Btnsave_Click1" />--%>
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="drpLine" runat="server" AutoPostBack="true" onselectedindexchanged="drpLine_SelectedIndexChanged">
                                                <asp:ListItem>-</asp:ListItem>
                                                <asp:ListItem>LINE 101</asp:ListItem>  
                                                <asp:ListItem>LINE 102</asp:ListItem>  
                                                <asp:ListItem>LINE 103</asp:ListItem>  
                                                <asp:ListItem>LINE 104</asp:ListItem>  
                                                <asp:ListItem>LINE 105</asp:ListItem> 
                                                <asp:ListItem>LINE 106</asp:ListItem>
                                                <asp:ListItem>LINE 107</asp:ListItem>
                                                <asp:ListItem>LINE 108</asp:ListItem>
                                                <asp:ListItem>LINE 109</asp:ListItem>
                                                <asp:ListItem>LINE 110</asp:ListItem>
                                                <asp:ListItem>LINE 111</asp:ListItem>
                                                <asp:ListItem>LINE 112</asp:ListItem>
                                                <asp:ListItem>LINE 113</asp:ListItem>
                                                <asp:ListItem>LINE 114</asp:ListItem>
                                                <asp:ListItem>LINE 115</asp:ListItem>
                                                <asp:ListItem>LINE 116</asp:ListItem>
                                                <asp:ListItem>LINE 117</asp:ListItem>
                                                <asp:ListItem>LINE 118</asp:ListItem>
                                                <asp:ListItem>LINE 119</asp:ListItem>
                                                <asp:ListItem>LINE 120</asp:ListItem>
												<asp:ListItem>LINE 121</asp:ListItem>
												<asp:ListItem>LINE 122</asp:ListItem>
												<asp:ListItem>LINE 123</asp:ListItem>
												<asp:ListItem>LINE 124</asp:ListItem>
												<asp:ListItem>LINE 125</asp:ListItem>
												<asp:ListItem>LINE 126</asp:ListItem>
												<asp:ListItem>LINE 127</asp:ListItem>
												<asp:ListItem>LINE 128</asp:ListItem>
												<asp:ListItem>LINE 129</asp:ListItem>
												<asp:ListItem>LINE 130</asp:ListItem>
												<asp:ListItem>LINE 131</asp:ListItem>
												<asp:ListItem>LINE 132</asp:ListItem>
												<asp:ListItem>LINE 133</asp:ListItem>
												<asp:ListItem>LINE 134</asp:ListItem>
												<asp:ListItem>LINE 135</asp:ListItem>
												<asp:ListItem>LINE 136</asp:ListItem>
												<asp:ListItem>LINE 137</asp:ListItem>
												<asp:ListItem>LINE 138</asp:ListItem>
												<asp:ListItem>LINE 139</asp:ListItem>
												<asp:ListItem>LINE 140</asp:ListItem>
												<asp:ListItem>LINE 141</asp:ListItem>
												<asp:ListItem>LINE 142</asp:ListItem>
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        ...
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------1st Aug-10th Aug-------">
        ...
        <AlternatingRowStyle BackColor="White" />
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------11th Aug-20th Aug-------">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
        ...
        <AlternatingRowStyle BackColor="White" />
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------21th Aug-31st Aug-------">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
        ...
        <AlternatingRowStyle BackColor="White" />
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------1st Sep-10th Sep-------">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
        ...
        <AlternatingRowStyle BackColor="White" />
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------11th Sep-20th Sep-------">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
        ...
        <AlternatingRowStyle BackColor="White" />
        <Columns>  
            <asp:BoundField DataField="line_no"  HeaderText="-------21st Sep-30th Sep-------">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
