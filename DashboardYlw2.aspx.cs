...
public partial class DashboardYlw2 : System.Web.UI.Page
{
    ...
    {
        //Red All
        SqlCommand StoredProcedureCommand = new SqlCommand("Sp_Red_AllYlw", conn);
        ...
        {
            string Red = TheReader["TtlRedAllYlw"].ToString();
            lblRed.Text = Red;
        ...
        //Red Merchandiser
        SqlCommand StoredProcedureCommandM = new SqlCommand("Sp_Red_MerchandisngMYlw", conn);
        ...
        while (daM.Read())
        {
            string Red = daM["TtlRedMerYlw"].ToString();
            lblRedM.Text = Red;
        ...
        //Red Yarn
        SqlCommand StoredProcedureCmdYarn = new SqlCommand("Sp_Red_YarnYlw", conn);
        ...
        while (daYarn.Read())
        {
            string Red = daYarn["TtlRedYarnYlw"].ToString();
            lblRedY2.Text = Red;
        ...
        //Red Yarn Dyeing
        SqlCommand StoredProcedureCommandYD = new SqlCommand("Sp_Red_YarnDyedYlw", conn);
        ...
        while (daYD.Read())
        {
            string Red = daYD["TtlRedYdYlw"].ToString();
            lblRedYD.Text = Red;
        ...
        //Red knitting
        SqlCommand StoredProcedureCommandK = new SqlCommand("Sp_Red_KnittingYlw", conn);
        ...
        while (daK.Read())
        {
            string Red = daK["TtlRedKnitYlw"].ToString();
            lblRedK.Text = Red;
        ...
        //Red Dyeing
        SqlCommand StoredProcedureCommandD = new SqlCommand("Sp_Red_DyeingYlw", conn);
        ...
        while (daD.Read())
        {
            string Red = daD["TtlRedDyeYlw"].ToString();
            lblRedD.Text = Red;
        ...
        //Red AOP
        SqlCommand StoredProcedureCommandA = new SqlCommand("Sp_Red_AopYlw", conn);
        ...
        while (daA.Read())
        {
            string Red = daA["TtlRedAopYlw"].ToString();
            lblRedA.Text = Red;
        ...
        //Red Accessories
        SqlCommand StoredProcedureCommandAC = new SqlCommand("Sp_Red_AccesYlw", conn);
        ...
        while (daAC.Read())
        {
            string Red = daAC["TtlRedAccesYlw"].ToString();
            lblRedAC.Text = Red;
        ...
        //Red Inventory
        SqlCommand StoredProcedureCommandI = new SqlCommand("Sp_Red_InventoryYlw", conn);
        ...
        while (daI.Read())
        {
            string Red = daI["TtlRedInventYlw"].ToString();
            lblRedI.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandP = new SqlCommand("Sp_Red_PrntYlw", conn);
        ...
        while (daP.Read())
        {
            string Red = daP["TtlRedPrntYlw"].ToString();
            lblRedP.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandEM = new SqlCommand("Sp_Red_EmbYlw", conn);
        ...
        while (daEM.Read())
        {
            string Red = daEM["TtlRedEmbYlw"].ToString();
            lblRedEM.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandRMG = new SqlCommand("Sp_Red_rmgYlw", conn);
        ...
        while (daRMG.Read())
        {
            string Red = daRMG["TtlRedrmgYlw"].ToString();
            lblRedRMG.Text = Red;
