<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShipmentDone.aspx.cs" Inherits="ShipmentDone" %>
...
<script type = "text/javascript">
    ...
    <div class="FldFream1">
      <div style="padding: 2px; margin: 0px; border-bottom-style: solid; height:25px; border-bottom-width: 0px; border-bottom-color: #006699; background-color: #3a5795;" >
          ...
          <asp:HyperLink ID="HyperLink4" runat="server" CssClass="MhyperLnk" Width="20%" NavigateUrl="~/page2.aspx"
                    BackColor="#FFFF95"><i class="fa fa-plane"></i> SHIPMENT DONE ORDER <i class="fa fa-caret-right"></i> </asp:HyperLink>
                 ...
                 <asp:GridView ID="Gvorder" runat="server" AutoGenerateColumns="False" CssClass="gridcss2"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <HeaderStyle CssClass="gridheade" />
                            <HeaderTemplate>
                                SHIPMENT DATE</HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" CssClass="gridlbl" Text='<%# Eval("PO_Ship_Date","{0:dd/MMM/yyyy}")%>'>></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <HeaderStyle CssClass="gridheade" />
