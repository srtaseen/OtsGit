<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Export.aspx.cs" Inherits="Export" %>
        ...
        <ContentTemplate>
             ...
             <asp:HyperLink ID="HyperLink10" runat="server" CssClass="MhyperLnk" width="15%"
                ...
                <fieldset style="border:1px solid white;"> 
                    <b style="text-align:center;margin-left:600px;">Shipmented Style Information</b>
       <table class="TblStyle" style="margin-top:10px; width:70%">
            <tr>
                            ...
                            <tr>
                                 ...
                                 <td height="18px" width="100px">
                                    <span class="text-primary">Shipment Date </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td height="18px" width="100px">
                                    <span class="text-primary">FOB </span>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtFob" runat="server" CssClass="textbox" Width="200px">                                       
                            </asp:TextBox>
                                </td>  
                                
                                <%--<td height="18px" width="200px">
                                    <span class="text-primary">Original Ship Date </span>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtship" runat="server" CssClass="textbox" Width="200px">                                       
                            </asp:TextBox>
                                </td>  --%>
                            </tr>
                ...
                <table class="TblStyle">
                    <tr>
                        <td height="18px" width="100px">
                           <span class="sp1">Size Wise Shipmented Qty</span>
                        </td>
                        <td>
                        </td>
                        <td>
