...
public partial class Article_Create_TNA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    return;
        //}
        //SqlCommand command = new SqlCommand("SELECT Username FROM [View_FormNameByUser] WHERE Username = '" + Session["Username"] + "'and (UsrDpt='6' OR UsrGroup='1') and frmnam4 = 'Page7.aspx' ", conn);
    ...
    private void Bindddlusername()
    {
        ...
        SqlConnection conn = new SqlConnection(DbConnect.x);
        String strQuery = "Select UserId,Username FROM Users order by Username ASC ";
        SqlCommand cmd = new SqlCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = strQuery;
        cmd.Connection = conn;
    ...
    private void FetchProductData()
    {
        ...
        string queryString = "SELECT ord_cnfdate,po_xfactory,po_quantity,po_led,po_bpsd FROM PO_Master where po_id=@po_id ";
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            txtqty.Text = dt.Rows[0]["po_quantity"].ToString();
    ...
    protected void btnGenarate_Click(object sender, EventArgs e)
    {
        ...
        this.lblpl60.Enabled = false;
        this.lblpl61.Enabled = false;
        this.lblpl70.Enabled = false;
        ...
        this.imgPopup60.Visible = false;
        this.imgPopup61.Visible = false;

        //if (ddTnacategory.SelectedItem.Value.ToString() == txtled.Text.ToString())
		
		if (ddlbuyer.SelectedItem.Text == "LIDL" || ddlbuyer.SelectedItem.Text == "ALDI(GP)" || ddlbuyer.SelectedItem.Text == "ALDI(GP)-SOUTH" || ddlbuyer.SelectedItem.Text == "ALDI(GP)-NORTH" || ddlbuyer.SelectedItem.Text == "GDS")
		{
            ...
            Double d19 = Double.Parse(lblg19.Text);
            Double dt19 = (v1 * d19) / 45;
            lblpl19.Text = DateTime.Parse(lblpl35.Text).AddDays(-7).ToShortDateString();//14
            ...
            Double d20 = Double.Parse(lblg20.Text);
            Double dt20 = (v1 * d20) / 45;
            lblpl20.Text = DateTime.Parse(lblpl19.Text).AddDays(2).ToShortDateString();//15
            ...
            //dummy position
            lbl70.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt23"].ToString();
            lblg70.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay23"].ToString();
            Double d70 = Double.Parse(lblg70.Text);
            Double dt70 = (v1 * d70) / 45;
            lblpl70.Text = DateTime.Parse(lblpl22.Text).AddDays(dt70).ToShortDateString();//Yarn Inhouse Strt
            ...
            lblpl56.Text = DateTime.Parse(lblpl70.Text).AddDays(dt56).ToShortDateString();//Yarn Dye Srat
			...
			lblpl28.Text = DateTime.Parse(lblpl43.Text).AddDays(-10).ToShortDateString();//Dyeing End
			...
			lblpl26.Text = DateTime.Parse(lblpl28.Text).AddDays(-7).ToShortDateString();//Knitting End
			...
			lblpl25.Text = DateTime.Parse(lblpl70.Text).AddDays(dt25).ToShortDateString();//Knitting Start

            //dummy position to replace yarn inhouse
            ...
            lblpl23.Text = DateTime.Parse(lblpl25.Text).AddDays(-10).ToShortDateString();//Yarn Inhouse Strt
            ...
            lblpl24.Text = DateTime.Parse(lblpl26.Text).AddDays(-10).ToShortDateString();//Yarn inhouse End
			...
			Double dt40 = (v1 * d40) / 45;
			lblpl40.Text = DateTime.Parse(lblpl36.Text).AddDays(dt40).ToShortDateString();//Emb Start
			...
			lblpl46.Text = DateTime.Parse(lblpl42.Text).AddDays(15).ToShortDateString();//1
            ...
            Double d50 = Double.Parse(lblg50.Text);
            Double dt50 = (v1 * d50) / 45;
            lblpl50.Text = DateTime.Parse(txtbpsd.Text).AddDays(-dt50).ToShortDateString();//5

            lbl51.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt51"].ToString();
            lblg51.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay51"].ToString();
            Double d51 = Double.Parse(lblg51.Text);
            Double dt51 = (v1 * d51) / 45;
            lblpl51.Text = DateTime.Parse(txtbpsd.Text).AddDays(-dt51).ToShortDateString();//6
			...
			//Accessories PI Receive

			lbl60.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt60"].ToString();
			lblg60.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay60"].ToString();
			Double d60 = Double.Parse(lblg60.Text);
			lblpl60.Text = DateTime.Parse(lblpl3.Text).AddDays(d60).ToShortDateString();


			//Acc BBLC Open
			lbl61.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt61"].ToString();
			lblg61.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay61"].ToString();
			Double d61 = Double.Parse(lblg61.Text);
			lblpl61.Text = DateTime.Parse(lblpl60.Text).AddDays(d61).ToShortDateString();
		...
		else if (ddlbuyer.SelectedItem.Text == "MOTHERCARE" || ddlbuyer.SelectedItem.Text == "RED TAPE")
        {
            ...
            Double d19 = Double.Parse(lblg19.Text);
            Double dt19 = (v1 * d19) / 45;
            lblpl19.Text = DateTime.Parse(lblpl35.Text).AddDays(-3).ToShortDateString();//14
		...
		else if (ddlbuyer.SelectedItem.Text == "DELPHITEX")
        {
            ...
            Double d9 = Double.Parse(lblg9.Text);
            Double dt9 = (v1 * d9) / 45;
            lblpl9.Text = DateTime.Parse(lblpl8.Text).AddDays(7).ToShortDateString();//4
            ...
            Double d16 = Double.Parse(lblg16.Text);
            Double dt16 = (v1 * d16) / 45;
            lblpl16.Text = DateTime.Parse(lblpl7.Text).AddDays(7).ToShortDateString();//11

            lbl17.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt17"].ToString();
            lblg17.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay17"].ToString();
            Double d17 = Double.Parse(lblg17.Text);
            Double dt17 = (v1 * d17) / 45;
            lblpl17.Text = DateTime.Parse(lblpl16.Text).AddDays(7).ToShortDateString();//12
		...
		else if (ddlbuyer.SelectedItem.Text == "ZXY")
        {
            ...
            Double d19 = Double.Parse(lblg19.Text);
            Double dt19 = (v1 * d19) / 45;
            lblpl19.Text = DateTime.Parse(lblpl35.Text).AddDays(-2).ToShortDateString();//14
            ...
            Double d20 = Double.Parse(lblg20.Text);
            Double dt20 = (v1 * d20) / 45;
            lblpl20.Text = DateTime.Parse(lblpl19.Text).AddDays(1).ToShortDateString();//15
		...
		else if (ddlbuyer.SelectedItem.Text == "NEXT")
        {
            ...
            Double d9 = Double.Parse(lblg9.Text);
            Double dt9 = (v1 * d9) / 45;
            lblpl9.Text = DateTime.Parse(lblpl8.Text).AddDays(4).ToShortDateString();//4
            ...
            Double d11 = Double.Parse(lblg11.Text);
            Double dt11 = (v1 * d11) / 45;
            lblpl11.Text = DateTime.Parse(lblpl10.Text).AddDays(4).ToShortDateString();//6
            ...
            Double d13 = Double.Parse(lblg13.Text);
            Double dt13 = (v1 * d13) / 45;
            lblpl13.Text = DateTime.Parse(lblpl12.Text).AddDays(4).ToShortDateString();//8
            ...
            Double d17 = Double.Parse(lblg17.Text);
            Double dt17 = (v1 * d17) / 45;
            lblpl17.Text = DateTime.Parse(lblpl16.Text).AddDays(2).ToShortDateString();//12
            ...
            Double d19 = Double.Parse(lblg19.Text);
            Double dt19 = (v1 * d19) / 45;
            lblpl19.Text = DateTime.Parse(lblpl35.Text).AddDays(-6).ToShortDateString();//14
            ...
            Double d21 = Double.Parse(lblg21.Text);
            Double dt21 = (v1 * d21) / 45;
            lblpl21.Text = DateTime.Parse(lblpl5.Text).AddDays(3).ToShortDateString();//Pi recv
            ...
            Double d22 = Double.Parse(lblg22.Text);
            Double dt22 = (v1 * d22) / 45;
            lblpl22.Text = DateTime.Parse(lblpl21.Text).AddDays(3).ToShortDateString();//BBlc Open
            ...
            Double d23 = Double.Parse(lblg23.Text);
            Double dt23 = (v1 * d23) / 45;
            lblpl23.Text = DateTime.Parse(lblpl25.Text).AddDays(-4).ToShortDateString();//Yarn Inhouse Strt
		...
		else if (ddlbuyer.SelectedItem.Text == "WOOLWORTHS")
        {
            ...
            Double d17 = Double.Parse(lblg17.Text);
            Double dt17 = (v1 * d17) / 45;
            lblpl17.Text = DateTime.Parse(lblpl19.Text).AddDays(10).ToShortDateString();//12

            lbl18.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt18"].ToString();
            lblg18.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay18"].ToString();
            Double d18 = Double.Parse(lblg18.Text);
            Double dt18 = (v1 * d18) / 45;
            lblpl18.Text = DateTime.Parse(lblpl17.Text).AddDays(7).ToShortDateString();//13
            ...
            Double d46 = Double.Parse(lblg46.Text);
            Double dt46 = (v1 * d46) / 45;
            lblpl46.Text = DateTime.Parse(lblpl19.Text).AddDays(10).ToShortDateString();//1

            lbl47.Text = ds.Tables[0].Rows[0]["Tmplt_Evnt47"].ToString();
            lblg47.Text = ds.Tables[0].Rows[0]["Tmplt_EvntDay47"].ToString();
            Double d47 = Double.Parse(lblg47.Text);
            Double dt47 = (v1 * d47) / 45;
            lblpl47.Text = DateTime.Parse(lblpl46.Text).AddDays(7).ToShortDateString();//2
		...
		else if (ddlbuyer.SelectedItem.Text == "PEACOCK(EWM)")
        {
    ...
    protected void TnALoad_Click(object sender, EventArgs e)
    {
...

        {
            ...
            {
                using (SqlCommand Syscmd = new SqlCommand("Sp_Art_TNA_Plan"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        Syscmd.Parameters.AddWithValue("Tnapl40", lblpl40.Text.Trim());//EMB Start
    ...
    protected void ddlarticle_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        String strQuery = "select DISTINCT po_id,po_no FROM PO_Master where art_no='" + ddlarticle.SelectedItem.Text + "'AND TnaCreateDate is NULL ";
        SqlCommand cmd = new SqlCommand();
