<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OrderInHand.aspx.cs" Inherits="OrderInHand" %>
    ...
    <script>
       ...
       <script type = "text/javascript">
           ...
           function showModalPopUp() {
               popUpObj = window.open("OrderInHandSummary.aspx",
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=no," +
    "location=no," +
