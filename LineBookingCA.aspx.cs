...
public partial class LineBookingCA : System.Web.UI.Page
{
    ...
    protected void GetStn_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection conn = new SqlConnection(DbConnect.x);
        String strQuery1 = "select  DISTINCT art_no FROM Article_Master where ord_no='" + GetStn.SelectedItem.Value + "' ";
        SqlCommand cmd1 = new SqlCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = strQuery1;
        cmd1.Connection = conn;
    ...
    protected void Btnsave_Click1(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            Syscmd.Parameters.AddWithValue("@po_no", GetPo.SelectedItem.Text.Trim());
