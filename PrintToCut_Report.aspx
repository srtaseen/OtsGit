<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PrintToCut_Report.aspx.cs" Inherits="PrintToCut_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <ContentTemplate>
            ...
            <div style="min-height:500px;">
               <%-- <div style="padding-top:10px;text-align:center;">Production Report</div>--%>
                <h1 class="header">Print To Cutting Report</h1>
    ...
    <div>
        ...
        <asp:BoundField DataField="sp_SizeQty" HeaderText="Transfer Qty" />
