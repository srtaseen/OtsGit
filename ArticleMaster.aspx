<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ArticleMaster.aspx.cs" Inherits="ArticleMaster" %>
            ...
            Font-Underline="False" BackColor="#ECF1FF">MERCHANDISING </asp:HyperLink>--%>
                        ...
                        <div class="submenuM">
                            <ul class="rootM">
                                ...
                                <li style="background-color: #3a5795"><a href="ArticleMaster.aspx">Order Article Master</a></li>
                    ...
                    <fieldset class="fld111">
                        <table class="TblStyle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="stnm" runat="server" CssClass="textbox" Width="100%"></asp:TextBox>
                                </td>
                                <td width="15px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="GetByr" runat="server" CssClass="textbox" Width="100%">
                            ...
                            <asp:GridView ID="GridViewpo" runat="server" ShowFooter="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ARTICLE NAME">
                                        ...
                                        <ItemTemplate>
                                            <div style="float: left; width: 120px;">
                                                <asp:TextBox ID="txtArt" runat="server" AutoPostBack="True" Width="98%" CssClass="Gridtextbox"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridheade" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="QUANTITY">
                                        ...
                                        <ItemTemplate>
                                            <div style="float: left; width: 120px;">
                                                <asp:TextBox ID="txtQty" runat="server" Width="98%" AutoPostBack="True" CssClass="Gridtextbox"></asp:TextBox>
                                            </div>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="gridheade" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="ITEM">
                                        ...
                                        <ItemTemplate>
                                            <div style="float: left; width: 120px">
                                                 <%--<asp:Label ID="lblItem" runat="server" Text='<%# Eval("gmtyp") %>' Visible = "false" />--%>
                                                <asp:DropDownList ID="ddlItem" runat="server" Width="98%" CssClass="Gridtextbox"
