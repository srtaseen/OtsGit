<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CuttingToPrintRx.aspx.cs" Inherits="CuttingToPrintRx" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset style="border:1px solid white;"> 
                    <b style="text-align:center;margin-left:600px;">Cutting To Print Receive</b>
