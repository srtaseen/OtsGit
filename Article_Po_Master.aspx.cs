...
public partial class Article_Po_Master : System.Web.UI.Page
{
    SqlConnection conn = new SqlConnection(DbConnect.x);
    protected void Page_Load(object sender, EventArgs e)
    {
        //entdt_CalendarExtender.EndDate = DateTime.Now;
		//entdt_CalendarExtender.StartDate = DateTime.Now;
    ...
    private void BindGetStle()
    {
        ...
        using (SqlConnection conn = new SqlConnection(DbConnect.x))
        {
            ...
            conn.Open();
            SqlDataReader rdr = cmd.ExecuteReader();
            GetStyle.DataTextField = "byr_nm";
            GetStyle.DataValueField = "byr_id";
    ...
    protected void txtspdt_TextChanged(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridViewpo.Rows.Count; i++)
        {
            ...
            if (GetByr.SelectedItem.Text == "ALDI(GP)")
            {
                txtexft.Text = DateTime.Parse(txtspdt.Text).AddDays(-15).ToShortDateString();
            }
			
			else if (GetByr.SelectedItem.Text == "ALDI(GP)-SOUTH")
            {
                txtexft.Text = DateTime.Parse(txtspdt.Text).AddDays(-15).ToShortDateString();
            }
			
			else if (GetByr.SelectedItem.Text == "ALDI(GP)-NORTH")
            {
                txtexft.Text = DateTime.Parse(txtspdt.Text).AddDays(-15).ToShortDateString();
            }

            else if (GetByr.SelectedItem.Text == "LIDL")
            {
                txtexft.Text = DateTime.Parse(txtspdt.Text).AddDays(-15).ToShortDateString();
            }

            else if (GetByr.SelectedItem.Text == "LI & FUNG")
            {
                txtexft.Text = DateTime.Parse(txtspdt.Text).AddDays(-15).ToShortDateString();
            }
            ...
            else if (GetByr.SelectedItem.Text == "ALDI(GP)")
            {
				...
				//change here by rus on 28.11.17 56-64//
                if (int.Parse(txtld.Text) == 120) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-64).ToShortDateString();
                ...
                if (int.Parse(txtld.Text) >= 135) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-72).ToShortDateString();

                }
                if (int.Parse(txtld.Text) >= 140) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-74).ToShortDateString();

                }
                if (int.Parse(txtld.Text) >= 145) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-75).ToShortDateString();
			...
			//new customize tna for PEACOCK(EWM) start

            else if (GetByr.SelectedItem.Text == "PEACOCK(EWM)")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			//new customize tna for DEBENHAMS(NEW) start

            else if (GetByr.SelectedItem.Text == "DEBENHAMS(NEW)")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			//new customize tna for TEXKOM start

            else if (GetByr.SelectedItem.Text == "TEXKOM")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
            ...
            else if (GetByr.SelectedItem.Text == "ZXY")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			else if (GetByr.SelectedItem.Text == "WOOLWORTHS")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			//new customize tna for PORTFOLIO start

            else if (GetByr.SelectedItem.Text == "PORTFOLIO")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			//new customize tna for New Yorker start

            else if (GetByr.SelectedItem.Text == "NEW YORKER")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
			...
			//new customize tna for ANSARI & BHASIN start
			
			else if (GetByr.SelectedItem.Text == "ANSARI & BHASIN")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
				...
				//new customize tna for ANSARI & BHASIN end

            //new customize tna for Tesco end

			else if (GetByr.SelectedItem.Text == "OTTO")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
            ...
            //new customize tna for OTTO end
			
			else if (GetByr.SelectedItem.Text == "SOL's")
            {
                if (int.Parse(txtld.Text) <= 45) //50 days order lead time//
                {
                    txtbss.Text = DateTime.Parse(txtexft.Text).AddDays(-25).ToShortDateString();
    ...
    private void SendOrderEmail(int ord_id)
    {
        ...
        using (MailMessage mm = new MailMessage("info@nz-bd.com", "otsneworder@nz-bd.com"))
        {
            ...
            body += "<br /> Order Number : " + GetStyle.SelectedItem.ToString() + ",";
    ...
    protected void Btnsave_Click1(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridViewpo.Rows.Count; i++)
        {
            if (GridViewpo.Rows[i].Cells[7].Text != null)
            {
                SqlCommand Syscmd = new SqlCommand();
                Syscmd.CommandType = CommandType.StoredProcedure;
                Syscmd.CommandText = "Order_Article_PO_Data";



              Syscmd.Parameters.AddWithValue("@ord_no", GetStyle.SelectedValue);
                Syscmd.Parameters.AddWithValue("@ord_buyer", GetByr.SelectedValue);
                Syscmd.Parameters.AddWithValue("@art_no", GetArticle.SelectedValue);

               Syscmd.Parameters.AddWithValue("@grment_typ", hdGmtId.Value.Trim());
               Syscmd.Parameters.AddWithValue("@art_quantity", txtQty.Text.Trim());
                ...
                Syscmd.Parameters.AddWithValue("@Aop", c1);
                Syscmd.Parameters.AddWithValue("@Emb", c2);
                Syscmd.Parameters.AddWithValue("@Gmw", c3);
                Syscmd.Parameters.AddWithValue("@Prnt", c4);
                Syscmd.Parameters.AddWithValue("@SolidFab", c5);
                Syscmd.Parameters.AddWithValue("@Yd", c6);
    ...
    {
        GetStyle.Items.Clear();
        GetStyle.Items.Add(new ListItem("-", ""));
        GetStyle.AppendDataBoundItems = true;
        SqlConnection conn = new SqlConnection(DbConnect.x);
        ...
        {
            conn.Open();
            GetStyle.DataSource = cmd1.ExecuteReader();
            GetStyle.DataTextField = "ord_no";
            //ddlStyle.DataValueField = "ord_id";
            GetStyle.DataBind();
            if (GetStyle.Items.Count > 1)
            {
                GetStyle.Enabled = true;
            }
            else
            {


                GetStyle.Enabled = false;
            }
        }
        catch (Exception ex)
        {
    ...
    protected void GetStyle_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection conn = new SqlConnection(DbConnect.x);
        String strQuery1 = "select  DISTINCT art_no FROM Article_Master where ord_no='" + GetStyle.SelectedItem.Value + "' ";
        SqlCommand cmd1 = new SqlCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = strQuery1;
        cmd1.Connection = conn;
    ...
    protected void GetArticle_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt = new DataTable();
            String strQuery = "select  DISTINCT art_quantity,b.gmtyp as art_item,b.gmtid FROM Article_Master a inner join GarmentsType b on a.art_item=b.gmtid where art_no='" + GetArticle.SelectedItem.Value + "' ";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtItem.Text = dt.Rows[0]["art_item"].ToString();
                hdGmtId.Value = dt.Rows[0]["gmtid"].ToString();
            }
        }
        catch (Exception ex)
        {
