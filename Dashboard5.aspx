<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Dashboard5.aspx.cs" Inherits="Dashboard5" %>
                ...
                <asp:TabPanel ID="TabPanel1" runat="server">
                    <ContentTemplate>
                     ...
                     <div style="padding: 100px 100px 100px 120px; margin: 0px; border-bottom-style: solid; height:500px; border-bottom-width: 0px; border-bottom-color: #006699; background-color: #4ca9ff;" >
                         ...
                         <h2 style="text-align:center;">Buyerwise Red Summery <= 7 Days</h2>
