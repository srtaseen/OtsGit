<%@ Page Title="OTS | EMB EVENTS" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true"
    CodeFile="Page28.aspx.cs" Inherits="Page12" %>
                ...
                <div class="divnv">
                    <div style="float: left">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="MhyperLnk" BackColor="#FFFF95"
                            ...
                            BackColor="#ECF1FF" NavigateUrl="~/Page28.aspx"><i class="fa fa-caret-left"></i> EMBROIDERY</asp:HyperLink>
                        <asp:HyperLink ID="HyperLink4" runat="server" CssClass="MhyperLnk" 
                            BackColor="#ECF1FF" NavigateUrl="~/CuttingToEmbTx.aspx"><i class="fa fa-caret-left"></i> CUTTING TO EMB TRANSFER</asp:HyperLink>
                        <asp:HyperLink ID="HyperLink5" runat="server" CssClass="MhyperLnk" 
                            BackColor="#ECF1FF" NavigateUrl="~/CuttingToEmbRx.aspx"><i class="fa fa-caret-left"></i> CUTTING TO EMB RECEIVER</asp:HyperLink>
						<asp:HyperLink ID="HyperLink6" runat="server" CssClass="MhyperLnk" 
                            BackColor="#ECF1FF" NavigateUrl="~/CutToEmb_Report.aspx"><i class="fa fa-caret-left"></i> CUTTING TO EMB REPORT</asp:HyperLink>
						<asp:HyperLink ID="HyperLink7" runat="server" CssClass="MhyperLnk" 
                            BackColor="#ECF1FF" NavigateUrl="~/EmbToCut_Report.aspx"><i class="fa fa-caret-left"></i> EMB TO CUTTING REPORT</asp:HyperLink>	
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
        <div class="divbody2">
                    ...
                    <div style="background-color: #3a5795; width: 100%; height: 40px; float: left">
                        <table style="border-collapse: separate; border-spacing: 2px; float: left; margin-left: 4px;
                            ...
                            <tr>
                                ...
                                <td>
                                 <asp:DropDownList ID="ddlbuyerE" CssClass="textbox" runat="server" Width="152px" 
                                            Font-Size="11px" >
            ...
            <div style="float: left; overflow: auto; width: 99.9%;">
                ...
                <asp:UpdatePanel ID="up3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GvE" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            CssClass="gridcss4" OnRowDataBound="GvE_OnRowDataBound" AllowPaging="True" PagerSettings-PageButtonCount="5"
                            PagerSettings-Position="Bottom" PageSize="19" OnPageIndexChanging="GvE_PageIndexChanging">
                                         ...
                                         <td >
                                            ...
                                            <td >
                                             <asp:Label ID="lblStlid" Visible="false" runat="server" Text='<%# Eval("TnaPoNm")%>'></asp:Label>
                                               <asp:Button ID="btnActualpln" Enabled="false" Text='<%# Eval("Tnaac40","{0:dd/MMM/yyyy}")%>'
                                            ...
                                            <td >
                                               ...
                                               <asp:Button ID="btnActualpln2" Enabled="false" Text='<%# Eval("Tnaac41","{0:dd/MMM/yyyy}")%>'
                    ...
                    <div style="padding: 4px; margin-top: 2px; float: left; background-color: #3a5795;" id="dv1" runat="server">
                        <table >
                            ...
                            <tr>
                                ...
                                <td width="50px">
                                    <asp:Label ID="lblemb" runat="server" CssClass="lbl1" BackColor="#FFFF66" Text="" Font-Bold="true"
                                ...
                                <td  width="50px">
                                    <asp:Label ID="lblemb2" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="#FF8A6C" Font-Size="13px"></asp:Label>
                                </td>
                                <td align="right" width="40px">
                                    <span style="padding: 2px 2px 2px 0px; font-weight: bolder; font-size: 13px; font-family: Arial, Helvetica, sans-serif;">
                                        %</span>
