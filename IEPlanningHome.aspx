<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="IEPlanningHome.aspx.cs" Inherits="IEPlanningHome" %>
             ...
             <div style="width: 100%; height: 445px; float: left;  overflow: auto;">
                 ...
                 <div style="margin-top:20px;margin-left:100px;">
                    <table>
                        <tr>
                            <td>
                   <asp:HyperLink ID="HyperLink15" class="btn btn-info" runat="server" Font-Underline="False" BackColor="#3a5795" ForeColor="White" Font-Size="Medium" NavigateUrl="~/IELayoutF.aspx" Width="700px">IE Module </asp:HyperLink>
                     </td>
                           
                        </tr>
                        <tr>
                         <td>
                            <asp:HyperLink ID="HyperLink7" class="btn btn-info" runat="server" Font-Underline="False" BackColor="#3a5795" ForeColor="White" Font-Size="Medium" NavigateUrl="~/Page38.aspx" Width="700px">Planning Module </asp:HyperLink>
                    </td>
                            </tr>
                             </table>
             </div>
