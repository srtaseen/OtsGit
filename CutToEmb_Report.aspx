<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CutToEmb_Report.aspx.cs" Inherits="CutToEmb_Report" %>
        ...
        <ContentTemplate>
            ...
            <div style="min-height:500px;">
               <%-- <div style="padding-top:10px;text-align:center;">Production Report</div>--%>
                <h1 class="header">Cutting To Emb Report</h1>
