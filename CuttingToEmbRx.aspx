<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CuttingToEmbRx.aspx.cs" Inherits="CuttingToEmbRx" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset style="border:1px solid white;"> 
                    <b style="text-align:center;margin-left:600px;">Embroidery To Cutting Cut Panel Receive</b>
       <table class="TblStyle" style="margin-top:10px; width:70%">
            <tr>
                            ...
                            <tr>
                                 ...
                                 <td height="18px" width="100px">
                                    <span class="text-primary">Receive Date </span>
                                </td>
                                <td>
                ...
                <table class="TblStyle">
                    <tr>
                        <td height="18px" width="100px">
                           <span class="sp1">Size Wise Receive Qty</span>
                        </td>
                        <td>
                        </td>
                        <td>
