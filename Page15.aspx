<%@ Page Title="OTS | TEXHOME" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Page15.aspx.cs" Inherits="Page9" %>
    ...
    <div class="FldFream1">
        <div style="padding: 2px; margin: 0px; border-bottom-style: solid; height:25px; border-bottom-width: 0px; border-bottom-color: #006699; background-color: #3a5795;" >
                ...
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="MhyperLnk" width="10%"
                    BackColor="#ECF1FF" NavigateUrl="~/Page16.aspx"><i class="fa fa-bars"></i> YARN</asp:HyperLink>
                     <asp:HyperLink ID="HyperLink6" runat="server" CssClass="MhyperLnk" width="15%"
                    BackColor="#ECF1FF" NavigateUrl="~/Page17.aspx"><i class="fa fa-bars"></i> YARN DYEING</asp:HyperLink>
                <asp:HyperLink ID="HyperLink3" runat="server" CssClass="MhyperLnk" width="12%"
                    BackColor="#ECF1FF" ForeColor="#0033CC" NavigateUrl="~/Page21.aspx"><i class="fa fa-bars"></i> KNITTING</asp:HyperLink>
                     <asp:HyperLink ID="HyperLink4" runat="server" CssClass="MhyperLnk" width="12%"
                    BackColor="#ECF1FF" ForeColor="#0033CC" NavigateUrl="~/Page22.aspx"> <i class="fa fa-bars"></i> DYEING</asp:HyperLink>
                      <asp:HyperLink ID="HyperLink5" runat="server" CssClass="MhyperLnk" width="10%"
                    BackColor="#ECF1FF" ForeColor="#0033CC" NavigateUrl="~/Page23.aspx"> <i class="fa fa-bars"></i> AOP</asp:HyperLink>
				<asp:HyperLink ID="HyperLink7" runat="server" CssClass="MhyperLnk" width="20%"
                    BackColor="#ECF1FF" ForeColor="#0033CC" NavigateUrl="~/ExportExcelTextile2.aspx"> <i class="fa fa-bars"></i>EXPORT TO EXCEL</asp:HyperLink>
