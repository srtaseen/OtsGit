<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EmbToCut_Report.aspx.cs" Inherits="EmbToCut_Report" %>
        ...
        <ContentTemplate>
            ...
            <div style="min-height:500px;">
               <%-- <div style="padding-top:10px;text-align:center;">Production Report</div>--%>
                <h1 class="header">Emb To Cutting Report</h1>
