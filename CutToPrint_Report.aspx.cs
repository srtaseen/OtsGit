...
public partial class CutToPrint_Report : System.Web.UI.Page
{
    ...
    protected void btnsrc_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlDataAdapter adapter = new SqlDataAdapter("Sp_CutToPrintTxReport '" + this.txtDate.Text + "','" + this.drpFactory.SelectedValue + "'", cn);
