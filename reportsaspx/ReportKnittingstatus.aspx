<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportKnittingstatus.aspx.cs" Inherits="reportsaspx_ReportOrderInhand" %>
    ...
    <div>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <div style="float: left; width:810px; margin-top: 5px; background-color: #FFFFFF; margin-left: 2px">
            ...
            <LocalReport ReportPath="reports\KnittingStatus.rdlc">
            </LocalReport>
             </rsweb:ReportViewer>
