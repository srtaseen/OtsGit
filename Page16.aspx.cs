...
{ 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand command = new SqlCommand("SELECT Username FROM [View_FormNameByUser] WHERE Username = '" + Session["Username"] + "'and (UsrDpt='5' OR UsrGroup='1') and frmnam8 = 'Page16.aspx'  ", conn);
    ...
    protected void btnActualpln_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand Syscmd = new SqlCommand("update Tbl_TnaPlan set Tnaac21='" + DateTime.Now + "' where TnaPoNm=" + lblStlid.Text + "", conn);
    ...
    protected void btnActualpln2_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand Syscmd = new SqlCommand("update Tbl_TnaPlan set Tnaac22='" + DateTime.Now + "' where TnaPoNm=" + lblStlid2.Text + "", conn);
        Syscmd.CommandType = CommandType.Text;
        Syscmd.Connection = conn;
        conn.Open();
        Syscmd.ExecuteNonQuery();
    ...
    protected void btnActualpln3_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand Syscmd = new SqlCommand("update Tbl_TnaPlan set Tnaac23='" + DateTime.Now + "' where TnaPoNm=" + lblStlid3.Text + "", conn);
        Syscmd.CommandType = CommandType.Text;
        Syscmd.Connection = conn;
        conn.Open();
        Syscmd.ExecuteNonQuery();
    ...
    protected void btnActualpln4_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand Syscmd = new SqlCommand("update Tbl_TnaPlan set Tnaac24='" + DateTime.Now + "' where TnaPoNm=" + lblStlid4.Text + "", conn);
        Syscmd.CommandType = CommandType.Text;
        Syscmd.Connection = conn;
        conn.Open();
        Syscmd.ExecuteNonQuery();
