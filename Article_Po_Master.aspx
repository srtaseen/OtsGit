<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Article_Po_Master.aspx.cs" Inherits="Article_Po_Master" %>
                        ...
                        <table class="TblStyle">
                            <tr>
                                <td height="18px" width="100px">
                                    <span class="sp1">ARTICLE DETAILS</span>
                                </td>
                                <td>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="GetByr" runat="server" CssClass="textbox" Width="98%" AutoPostBack="true" OnSelectedIndexChanged="GetByr_SelectedIndexChanged">
                             ...
                             <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="GetStyle" runat="server" CssClass="textbox" Width="98%" AutoPostBack="true" OnSelectedIndexChanged="GetStyle_SelectedIndexChanged">
                                        <asp:ListItem>-</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                             ...
                             <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="GetArticle" runat="server" CssClass="textbox" Width="98%" AutoPostBack="true" OnSelectedIndexChanged="GetArticle_SelectedIndexChanged">
                                        <asp:ListItem>-</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtQty" runat="server" CssClass="textbox" Width="98%"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td height="18px" width="100px">
                                    <span class="text-primary">Garments Item</span>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtItem" runat="server" CssClass="textbox" Width="98%"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td height="18px" width="100px" colspan="3">
                                    <span class="sp1">SPECIAL<asp:HiddenField ID="hdGmtId" runat="server" />
                                    &nbsp;OPERATION</span>
                                </td>
                            </tr>
                            <tr>
