<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="TechnicalApproval.aspx.cs" Inherits="TechnicalApproval" %>
                                        ...
                                        <ItemTemplate>
                                         ...
                                         <td >
                                            ...
                                            <td >
                                                ...
                                                <asp:Label ID="knitstart" runat="server" Font-Size="10px" CssClass="glbl" Text='<%# Eval("Tnaac19",  "{0:dd/MMM/yyyy}")%>'> </asp:Label>
                                            </td>

                                            <td >
                                                
                                                <asp:Label ID="lbl1" runat="server" Font-Size="10px" CssClass="glbl" Text='<%# Eval("Tnapl20",  "{0:dd/MMM/yyyy}")%>'> </asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                             <asp:Label ID="lblStlid" Visible="false" runat="server" Text='<%# Eval("TnaPoNm")%>'></asp:Label>
                                               <asp:Button ID="btnActualpln" Enabled="false" Text='<%# Eval("Tnaac20","{0:dd/MMM/yyyy}")%>'
