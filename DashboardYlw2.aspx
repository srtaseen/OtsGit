<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DashboardYlw2.aspx.cs" Inherits="DashboardYlw2" %>
        ...
        <div class="divnv">
            <div style="float: left">
                ...
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="MhyperLnk" BackColor="#ECF1FF"
                    NavigateUrl="~/DashboardYlw.aspx"><i class="fa fa-caret-left"></i> BACK TO Yellow DASHBOARD </asp:HyperLink>
                ...
                <asp:TabPanel ID="TabPanel1" runat="server">
                    <ContentTemplate>
                     ...
                     <div style="padding: 100px 100px 100px 120px; margin: 0px; border-bottom-style: solid; height:500px; border-bottom-width: 0px; border-bottom-color: #006699; background-color: #4ca9ff;" >
                         ...
                         <h2 style="text-align:center;">Buyerwise Yellow Summery</h2>
