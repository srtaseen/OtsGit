<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CuttingToEmbTx.aspx.cs" Inherits="CuttingToEmbTx" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <fieldset style="border:1px solid white;"> 
                    <b style="text-align:center;margin-left:600px;">Cutting To Embroidery Cut Panel Transfer</b>
