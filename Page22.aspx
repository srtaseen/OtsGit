<%@ Page Title="OTS | DYEING EVENTS" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true"
    CodeFile="Page22.aspx.cs" Inherits="Page12" %>
                ...
                <div class="divnv">
                    <div style="float: left">
                        ...
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="MhyperLnkD" 
                            BackColor="#ECF1FF"  Font-Underline="False"><i class="fa fa-caret-left"></i> DYEING EVENTS</asp:HyperLink>
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
                    ...
                    <div style="background-color: #3a5795; width: 100%; height: 40px; float: left">
                        <table style="border-collapse: separate; border-spacing: 2px; float: left; margin-left: 4px;
                            ...
                            <tr>
                                ...
                                <td>
                                 <asp:DropDownList ID="ddlbuyerD" CssClass="textbox" runat="server" Width="152px" 
                                            Font-Size="11px" >
                ...
                <asp:UpdatePanel ID="up3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GvD" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            CssClass="gridcss4" OnRowDataBound="GvD_OnRowDataBound" AllowPaging="True" PagerSettings-PageButtonCount="5"
                            PagerSettings-Position="Bottom" PageSize="19" OnPageIndexChanging="GvD_PageIndexChanging">
                                         ...
                                         <td width="200px">
                                            ...
                                            <td>
                                             <asp:Label ID="lblStlid" Visible="false" runat="server" Text='<%# Eval("TnaPoNm")%>'></asp:Label>
                                               <asp:Button ID="btnActualpln" Enabled="false" Text='<%# Eval("Tnaac27","{0:dd/MMM/yyyy}")%>'
                                            ...
                                            <td >
                                             <asp:Label ID="lblStlid2" Visible="false" runat="server" Text='<%# Eval("TnaPoNm")%>'></asp:Label>
                                               <asp:Button ID="btnActualpln2" Enabled="false" Text='<%# Eval("Tnaac28","{0:dd/MMM/yyyy}")%>'
                    ...
                    <div style="padding: 4px; margin-top: 2px; float: left; background-color: #3a5795;" id="dv1" runat="server">
                        <table >
                            ...
                            <tr>
                                ...
                                <td width="50px">
                                    <asp:Label ID="lblrdyed" runat="server" CssClass="lbl1" BackColor="#FFFF66" Text="" Font-Bold="true"
                                ...
                                <td style=" width="50px">
                                    <asp:Label ID="lblrdyed2" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="#FF8A6C" Font-Size="13px"></asp:Label>
                                </td>
                                <td align="right" width="40px">
                                    <span style="padding: 2px 2px 2px 0px; font-weight: bolder; font-size: 13px; font-family: Arial, Helvetica, sans-serif;">
                                        %</span>
