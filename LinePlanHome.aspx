<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LinePlanHome.aspx.cs" Inherits="LinePlanHome" %>
             ...
             <div style="width: 100%; height: 445px; float: left;  overflow: auto;">
                 ...
                 <div style="margin-top:20px;margin-left:100px;">
                    <table>
                        <tr>
                            <td>
                   <asp:HyperLink ID="HyperLink15" class="btn btn-info" runat="server" Font-Underline="False" BackColor="#3a5795" ForeColor="White" Font-Size="Medium" NavigateUrl="~/FilterLineBooking.aspx" Width="700px">Line Plan For NAZ </asp:HyperLink>
                     </td>
                           
                        </tr>
                        <tr>
                         <td>
                            <asp:HyperLink ID="HyperLink7" class="btn btn-info" runat="server" Font-Underline="False" BackColor="#3a5795" ForeColor="White" Font-Size="Medium" NavigateUrl="~/FilterLineBookingCA.aspx" Width="700px">Line Plan For CA </asp:HyperLink>
                    </td>
                            </tr>
                             </table>
             </div>
