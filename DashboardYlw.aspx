<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DashboardYlw.aspx.cs" Inherits="DashboardYlw" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRed" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                   ...
                                   <td align="right" width="40px" style="padding-left:40px; padding-top:10px;">
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedM" runat="server" Text="" CssClass="lbl1" Font-Bold="true"
                                            BackColor="yellow" Font-Size="15px" ForeColor="black"></asp:Label>
                                    </td>
                        ...
                        <div style="padding: 0px; margin-top: 20px; width:150px; height:80px; float: left; background-color: #3a5795;"
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedK" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                        ...
                        <div style="padding: 0px; margin-top: 20px; width:150px; height:80px; float: left; background-color: #3a5795;"
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedD" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                         ...
                         <div style="padding: 0px; margin-top: 20px; width:150px; height:80px; float: left; background-color: #3a5795;"
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedA" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td align="right" width="40px" style="padding-left:40px; padding-top:10px;">
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedAC" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td align="right" width="40px" style="padding-left:40px; padding-top:10px;">
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedI" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                         ...
                         <div style="padding: 0px; margin-top: 20px; width:150px; height:80px; float: left; background-color: #3a5795;"
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedP" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                        ...
                        <div style="padding: 0px; margin-top: 20px; width:150px; height:80px; float: left; background-color: #3a5795;"
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedEM" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
                            ...
                            <table style="float:left;">
                                ...
                                <tr>
                                   ...
                                   <td align="right" width="40px" style="padding-left:40px; padding-top:10px;">
                                    ...
                                    <td style=" width:50px; padding-top:10px; padding-left:10px;">
                                        <asp:Label ID="lblRedRMG" runat="server" Text="" CssClass="lbl1" Font-Bold="true" BackColor="yellow" ForeColor="black"
                                            Font-Size="15px"></asp:Label>
                                    </td>
    ...
    <div style="margin-left:75px;">
        ...
        <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/Dashboard.aspx" BackColor="#FFFF95"><i class="fa fa-home"></i> Red Summary </asp:HyperLink>
    </td>
	...
	<td style="width:200px; border:1px solid black; height:30px; text-align:center; font-weight:bolder;">
        <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/DashboardYlw2.aspx" BackColor="#FFFF95"><i class="fa fa-home"></i> Buyer Wise Yellow Summary</asp:HyperLink>
    </td>
    <td style="width:200px; border:1px solid black; height:30px; text-align:center; font-weight:bolder;">
