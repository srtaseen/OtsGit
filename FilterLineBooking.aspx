<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FilterLineBooking.aspx.cs" Inherits="FilterLineBooking" %>
                 ...
                 <asp:GridView ID="GvLineBooking" runat="server" AutoGenerateColumns="False" CssClass="gridcss2"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" CssClass="gridlbl" Text='<%# Eval("ent_date","{0:dd/MM/yyyy}")%>'>></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" CssClass="gridlbl" Text='<%# Eval("last_dt","{0:dd/MM/yyyy}")%>'>></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
