...
public partial class OrderMay17 : System.Web.UI.Page
{
    ...
    private void ShowReport()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "reports/ReportMay'17.rdlc";
...
where targetDate  between '2017-05-01' and '2017-05-07' 
...
where b.po_xfactory between '2017-05-01' and '2017-05-07' AND a.PO_Ship_Date is NULL AND b.ActiveOrder='1' AND b.TnAapproved IS NOT NULL 
...
where sd.ship_date between '2017-04-22' and '2017-04-30'
...
from tblShipmentDetails sd join PO_Master pm on sd.po_no=pm.po_no where sd.ship_date between '2017-05-01' and '2017-05-07'
...
(select c.byr_nm,sum(targetQty) as targetQty,avg(targetFob) as targetFob,avg(targetSmv) as targetSmv
from tblOrderTarget c
where targetDate  between '2017-05-08' and '2017-05-14' 
group by c.byr_nm) as c left join
(select b.byr_nm,sum(b.po_quantity) as po_quantity,sum(a.Totalprice) as Totalprice,avg(b.po_price) as po_price,avg(isnull(a.Smv,0)) as smv
from View_OrderInhand b join View_Tna_Plan a on b.byr_nm=a.byr_nm and  b.po_no=a.po_no and b.ord_no=a.ord_no
where b.po_xfactory between '2017-05-08' and '2017-05-14' AND a.PO_Ship_Date is NULL AND b.ActiveOrder='1' AND b.TnAapproved IS NOT NULL 
group by b.byr_nm) b on c.byr_nm=b.byr_nm  left join
(select bt.byr_nm, sum(sd.ship_remain) as remainQty
from tblShipmentDetails sd join (PO_Master pm join Buyer_Tab bt on pm.ord_buyer=bt.byr_id) on sd.po_no=pm.po_no 
where sd.ship_date between '2017-05-01' and '2017-05-07'
group by bt.byr_nm) sd on c.byr_nm=sd.byr_nm left join
(SELECT bt.byr_nm,sum(a.ship_quantity) as ship_quantity,sum(a.ship_tprice) as ship_tprice
from (SELECT pm.ord_buyer,pm.po_no,sum(sd.ship_quantity) as ship_quantity,(pm.po_price*sum(sd.ship_quantity)) as ship_tprice 
from tblShipmentDetails sd join PO_Master pm on sd.po_no=pm.po_no where sd.ship_date between '2017-05-08' and '2017-05-14'
group by pm.ord_buyer,pm.po_no,pm.po_price) a
join Buyer_Tab bt on a.ord_buyer=bt.byr_id
...
(select c.byr_nm,sum(targetQty) as targetQty,avg(targetFob) as targetFob,avg(targetSmv) as targetSmv
from tblOrderTarget c
where targetDate  between '2017-05-15' and '2017-05-21' 
group by c.byr_nm) as c left join
(select b.byr_nm,sum(b.po_quantity) as po_quantity,sum(a.Totalprice) as Totalprice,avg(b.po_price) as po_price,avg(isnull(a.Smv,0)) as smv
from View_OrderInhand b join View_Tna_Plan a on b.byr_nm=a.byr_nm and  b.po_no=a.po_no and b.ord_no=a.ord_no
where b.po_xfactory between '2017-05-15' and '2017-05-21' AND a.PO_Ship_Date is NULL AND b.ActiveOrder='1' AND b.TnAapproved IS NOT NULL 
group by b.byr_nm) b on c.byr_nm=b.byr_nm  left join
(select bt.byr_nm, sum(sd.ship_remain) as remainQty
from tblShipmentDetails sd join (PO_Master pm join Buyer_Tab bt on pm.ord_buyer=bt.byr_id) on sd.po_no=pm.po_no 
where sd.ship_date between '2017-05-08' and '2017-05-14'
group by bt.byr_nm) sd on c.byr_nm=sd.byr_nm left join
(SELECT bt.byr_nm,sum(a.ship_quantity) as ship_quantity,sum(a.ship_tprice) as ship_tprice
from (SELECT pm.ord_buyer,pm.po_no,sum(sd.ship_quantity) as ship_quantity,(pm.po_price*sum(sd.ship_quantity)) as ship_tprice 
from tblShipmentDetails sd join PO_Master pm on sd.po_no=pm.po_no where sd.ship_date between '2017-05-15' and '2017-05-21'
group by pm.ord_buyer,pm.po_no,pm.po_price) a
join Buyer_Tab bt on a.ord_buyer=bt.byr_id
group by bt.byr_nm) ss  on c.byr_nm=ss.byr_nm", conn);
            conn.Open();
...
(select c.byr_nm,sum(targetQty) as targetQty,avg(targetFob) as targetFob,avg(targetSmv) as targetSmv
from tblOrderTarget c
where targetDate  between '2017-05-22' and '2017-05-31' 
group by c.byr_nm) as c left join
(select b.byr_nm,sum(b.po_quantity) as po_quantity,sum(a.Totalprice) as Totalprice,avg(b.po_price) as po_price,avg(isnull(a.Smv,0)) as smv
from View_OrderInhand b join View_Tna_Plan a on b.byr_nm=a.byr_nm and  b.po_no=a.po_no and b.ord_no=a.ord_no
where b.po_xfactory between '2017-05-22' and '2017-05-31' AND a.PO_Ship_Date is NULL AND b.ActiveOrder='1' AND b.TnAapproved IS NOT NULL 
group by b.byr_nm) b on c.byr_nm=b.byr_nm  left join
(select bt.byr_nm, sum(sd.ship_remain) as remainQty
from tblShipmentDetails sd join (PO_Master pm join Buyer_Tab bt on pm.ord_buyer=bt.byr_id) on sd.po_no=pm.po_no 
where sd.ship_date between '2017-05-15' and '2017-05-21'
group by bt.byr_nm) sd on c.byr_nm=sd.byr_nm left join
(SELECT bt.byr_nm,sum(a.ship_quantity) as ship_quantity,sum(a.ship_tprice) as ship_tprice
from (SELECT pm.ord_buyer,pm.po_no,sum(sd.ship_quantity) as ship_quantity,(pm.po_price*sum(sd.ship_quantity)) as ship_tprice 
from tblShipmentDetails sd join PO_Master pm on sd.po_no=pm.po_no where sd.ship_date between '2017-05-22' and '2017-05-31'
group by pm.ord_buyer,pm.po_no,pm.po_price) a
join Buyer_Tab bt on a.ord_buyer=bt.byr_id
group by bt.byr_nm) ss  on c.byr_nm=ss.byr_nm", conn);
            conn.Open();
