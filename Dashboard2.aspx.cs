...
public partial class Dashboard2 : System.Web.UI.Page
{
    ...
    {
        //Red All
        SqlCommand StoredProcedureCommand = new SqlCommand("Sp_Red_All", conn);
        ...
        //Red Merchandiser
        SqlCommand StoredProcedureCommandM = new SqlCommand("Sp_Red_MerchandisngM", conn);
        ...
        while (daM.Read())
        {
            string Red = daM["TtlRedMer"].ToString();
            lblRedM.Text = Red;
        ...
        //Red Yarn
        SqlCommand StoredProcedureCmdYarn = new SqlCommand("Sp_Red_Yarn", conn);
        ...
        while (daYarn.Read())
        {
            string Red = daYarn["TtlRedYarn"].ToString();
            lblRedY2.Text = Red;
        ...
        //Red Yarn Dyeing
        SqlCommand StoredProcedureCommandYD = new SqlCommand("Sp_Red_YarnDyed", conn);
        ...
        while (daYD.Read())
        {
            string Red = daYD["TtlRedYd"].ToString();
            lblRedYD.Text = Red;
        ...
        //Red knitting
        SqlCommand StoredProcedureCommandK = new SqlCommand("Sp_Red_Knitting", conn);
        ...
        while (daK.Read())
        {
            string Red = daK["TtlRedKnit"].ToString();
            lblRedK.Text = Red;
        ...
        //Red Dyeing
        SqlCommand StoredProcedureCommandD = new SqlCommand("Sp_Red_Dyeing", conn);
        ...
        while (daD.Read())
        {
            string Red = daD["TtlRedDye"].ToString();
            lblRedD.Text = Red;
        ...
        //Red AOP
        SqlCommand StoredProcedureCommandA = new SqlCommand("Sp_Red_Aop", conn);
        ...
        while (daA.Read())
        {
            string Red = daA["TtlRedAop"].ToString();
            lblRedA.Text = Red;
        ...
        //Red Accessories
        SqlCommand StoredProcedureCommandAC = new SqlCommand("Sp_Red_Acces", conn);
        ...
        while (daAC.Read())
        {
            string Red = daAC["TtlRedAcces"].ToString();
            lblRedAC.Text = Red;
        ...
        //Red Inventory
        SqlCommand StoredProcedureCommandI = new SqlCommand("Sp_Red_Inventory", conn);
        ...
        while (daI.Read())
        {
            string Red = daI["TtlRedInvent"].ToString();
            lblRedI.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandP = new SqlCommand("Sp_Red_Prnt", conn);
        ...
        while (daP.Read())
        {
            string Red = daP["TtlRedPrnt"].ToString();
            lblRedP.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandEM = new SqlCommand("Sp_Red_Emb", conn);
        ...
        while (daEM.Read())
        {
            string Red = daEM["TtlRedEmb"].ToString();
            lblRedEM.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandRMG = new SqlCommand("Sp_Red_rmg", conn);
        ...
        while (daRMG.Read())
        {
            string Red = daRMG["TtlRedrmg"].ToString();
            lblRedRMG.Text = Red;
