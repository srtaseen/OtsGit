...
public partial class EditOrder : System.Web.UI.Page
{
    ...
    private void Bindddstyle()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select DISTINCT ord_no FROM Order_Master order by ord_no ASC", conn);
    ...
    protected void Bindgvedit()
    {
        ...
        conn.Open();
        SqlCommand cmd = new SqlCommand("select * FROM Order_Master WHERE ord_no = '" + ddstyle.SelectedItem.Text + "' ", conn);
    ...
    protected void gvedit_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        //TextBox txtordno = (TextBox)row.FindControl("txtordno");
        TextBox txtfactory = (TextBox)row.FindControl("txtfactory");
        ...
        SqlCommand cmd = new SqlCommand("update Order_Master set ord_factory='" + txtfactory.Text + "' where ord_id='" + art + "'", conn);
        cmd.ExecuteNonQuery();
        conn.Close();
        Bindgvedit();
    }
