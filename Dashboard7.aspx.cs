...
public partial class Dashboard7 : System.Web.UI.Page
{
    ...
    {
        //Red All
        SqlCommand StoredProcedureCommand = new SqlCommand("Sp_Red_All15", conn);
        ...
        {
            string Red = TheReader["TtlRed15"].ToString();
            lblRed.Text = Red;
        ...
        //Red Merchandiser
        SqlCommand StoredProcedureCommandM = new SqlCommand("Sp_Red_MerchandisngM15", conn);
        ...
        while (daM.Read())
        {
            string Red = daM["TtlRedMer15"].ToString();
            lblRedM.Text = Red;
        ...
        //Red Yarn
        SqlCommand StoredProcedureCmdYarn = new SqlCommand("Sp_Red_Yarn15", conn);
        ...
        while (daYarn.Read())
        {
            string Red = daYarn["TtlRedYarn15"].ToString();
            lblRedY2.Text = Red;
        ...
        //Red Yarn Dyeing
        SqlCommand StoredProcedureCommandYD = new SqlCommand("Sp_Red_YarnDyed15", conn);
        ...
        while (daYD.Read())
        {
            string Red = daYD["TtlRedYd15"].ToString();
            lblRedYD.Text = Red;
        ...
        //Red knitting
        SqlCommand StoredProcedureCommandK = new SqlCommand("Sp_Red_Knitting15", conn);
        ...
        while (daK.Read())
        {
            string Red = daK["TtlRedKnit15"].ToString();
            lblRedK.Text = Red;
        ...
        //Red Dyeing
        SqlCommand StoredProcedureCommandD = new SqlCommand("Sp_Red_Dyeing15", conn);
        ...
        while (daD.Read())
        {
            string Red = daD["TtlRedDye15"].ToString();
            lblRedD.Text = Red;
        ...
        //Red AOP
        SqlCommand StoredProcedureCommandA = new SqlCommand("Sp_Red_Aop15", conn);
        ...
        while (daA.Read())
        {
            string Red = daA["TtlRedAop15"].ToString();
            lblRedA.Text = Red;
        ...
        //Red Accessories
        SqlCommand StoredProcedureCommandAC = new SqlCommand("Sp_Red_Acces15", conn);
        ...
        while (daAC.Read())
        {
            string Red = daAC["TtlRedAcces15"].ToString();
            lblRedAC.Text = Red;
        ...
        //Red Inventory
        SqlCommand StoredProcedureCommandI = new SqlCommand("Sp_Red_Inventory15", conn);
        ...
        while (daI.Read())
        {
            string Red = daI["TtlRedInvent15"].ToString();
            lblRedI.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandP = new SqlCommand("Sp_Red_Prnt15", conn);
        ...
        while (daP.Read())
        {
            string Red = daP["TtlRedPrnt15"].ToString();
            lblRedP.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandEM = new SqlCommand("Sp_Red_Emb15", conn);
        ...
        while (daEM.Read())
        {
            string Red = daEM["TtlRedEmb15"].ToString();
            lblRedEM.Text = Red;
        ...
        //Red Printing
        SqlCommand StoredProcedureCommandRMG = new SqlCommand("Sp_Red_rmg15", conn);
        ...
        while (daRMG.Read())
        {
            string Red = daRMG["TtlRedrmg15"].ToString();
            lblRedRMG.Text = Red;
